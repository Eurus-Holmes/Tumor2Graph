...
class Simple_Protein_Predict(nn.Module):
    def __init__(self, filter_anti, cnn_anti_kernels, filter_virus, cnn_virus_kernels):
        super(Simple_Protein_Predict, self).__init__()
        self.filter_anti = filter_anti
        self.filter_virus = filter_virus
        self.cnn_anti_kernels = cnn_anti_kernels
        self.cnn_virus_kernels = cnn_virus_kernels
