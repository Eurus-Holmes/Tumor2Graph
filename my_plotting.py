...
def add_at_risk_counts(*fitters,cluster="At risk", labels: Optional[Union[Iterable, bool]] = None, rows_to_show=None, ypos=-0.6, ax=None, **kwargs):
    """
    ...
    for tick in ax2.get_xticks():
        ...
        if tick == ax2.get_xticks()[0]:
            ...
            for i, c in enumerate(counts):
                ...
                l = {"At risk": f"  {cluster}: ", "Censored": "Censored  ", "Events": " Events  "}.get(l)
#                s = "{}   ".format(l.rjust(10, " ")) + "{{:>{}d}}\n".format(max_length)
                s = "{}   ".format(l.ljust(10, " ")) + "{{:>{}d}}\n".format(4)
                lbl += s.format(c)
